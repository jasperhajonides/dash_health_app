...
def insert_nutrition_data(supabase_client, table_name, data):
    ...
    # (Assuming you know your table's schema and columns, you can list them here)
    valid_columns = [
        'id', 'name', 'username', 'meal_type', 'date', 'created_at','calculation_time', 'llm_output', 'prompt', 'description', 'glycemic_index', 'weight', 'weight_original','calories', 'fat', 'carbohydrates', 'protein', 
